...
async def start(bot, message):
    await message.reply(
        ...
        "**I am your Personal MDisk Link Converter Bot 🤗 made by @Madhavan842💞 Send me a MDisk Post to see the Magic 😅**")
    
@bot.on_message(filters.text & filters.private)
async def Doodstream_uploader(bot, message):
    new_string = str(message.text)
    conv = await message.reply("Wait Bnaraha Hu Tab Tak @M4_MOVIES_LINKS Check Karo✋")
